  ...
  return (
    <section aria-labelledby="ask-doubt-title" className="space-y-3">
      <div className="flex items-center gap-2">
        <div className="w-7 h-7 rounded-lg bg-[#12A594]/10 text-[#12A594] flex items-center justify-center">
          <HelpCircle className="w-4 h-4" />
        </div>
        <div>
          <h4 id="ask-doubt-title" className="text-sm font-semibold text-[#1E2233]">
            Ask a doubt
          </h4>
      ...
      <form onSubmit={handleSubmit} className="space-y-2">
        <textarea
          ...
          className="w-full p-3 text-xs sm:text-sm border border-[#E3E5EC] rounded-xl outline-none focus:border-[#12A594] focus:ring-1 focus:ring-[#12A594] resize-none disabled:bg-[#F5F6FA] disabled:cursor-not-allowed"
        />
        <div className="flex items-center justify-between gap-2">
          ...
          {user ? (
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 text-xs font-semibold text-white bg-[#12A594] hover:bg-[#0E8576] disabled:bg-[#CBD5E1] rounded-xl transition-colors cursor-pointer disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              className="px-4 py-2 text-xs font-semibold text-[#12A594] bg-[#12A594]/10 hover:bg-[#12A594]/20 rounded-xl cursor-pointer"
            >
              Sign in to ask
            </button>
          )}
      ...
      {lessonDoubts.length > 0 && (
        <div className="pt-3 border-t border-[#E3E5EC] space-y-2">
          <p className="text-xs font-bold text-[#1E2233] flex items-center gap-1.5">
          ...
          {lessonDoubts.map((d) => (
            <div
              key={d.id}
              className="p-3 rounded-xl bg-[#F5F6FA] border border-[#E3E5EC] space-y-2 text-xs"
            >
              <div className="flex items-center justify-between gap-2">
              ...
              {d.answer && (
                <p className="p-2.5 rounded-lg bg-white border border-[#BCE8DC] text-[#04342C] whitespace-pre-line">
                  <span className="font-bold">{d.answered_by || 'Educator'}: </span>
                  {d.answer}
                </p>
              )}
            </div>
